...
import type { AnimationProperty, AppearanceProperty, BorderCollapseProperty, BorderSpacingProperty, BoxSizingProperty, ClipProperty, CursorProperty, FloatProperty, FontVariantNumericProperty, ListStyleImageProperty, ListStylePositionProperty, ListStyleTypeProperty, ObjectFitProperty, ObjectPositionProperty, OpacityProperty, OutlineProperty, PointerEventsProperty, ResizeProperty, TableLayoutProperty, TransformOriginProperty, TransformProperty, TransitionProperty, UserSelectProperty, VisibilityProperty, WillChangeProperty } from 'csstype';
import type { PseudoPropStyles } from './PseudoPropStyles';
export interface BoxBaseStyleProps extends LayoutProps, SpaceProps, BackgroundProps, BorderProps, ShadowProps, PositionProps, TypographyProps, FlexboxProps {
...
export declare type BoxPseudoStyleProps = {
...
export declare type StyledBoxProps = BoxProps & {
