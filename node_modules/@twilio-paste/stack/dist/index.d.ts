...
declare type StackChildMargins = Pick<MarginProps, 'marginRight' | 'marginBottom'>;
declare type DisplayOptions = 'block' | 'flex';
declare type DisplayValue = ResponsiveValue<DisplayOptions>;
declare type StackOrientationOptions = 'horizontal' | 'vertical';
export declare type StackOrientation = ResponsiveValue<StackOrientationOptions>;
